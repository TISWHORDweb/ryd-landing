  ...
  return (
    <div className="container py-5">
      <header className="text-center mb-5">
        <h1 className="display-4 fw-bold mb-3" style={{ color: primaryColor }}>RYD Learning Program Structure</h1>
