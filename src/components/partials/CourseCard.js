...
const CourseCard = ({ courseDetails }) => {
  return (
    <div className="course__item" style={{ border: '1px solid rgba(240, 240, 240, 1)' }}>
      <div className="course__item-inner">
        ...
        <div className="course__content">
          <div className="course__content-top">
            <span className={`course__meta-tag course__meta-tag--cat${courseDetails.category === 'Basic' ? '1' : '2'}`}>
          ...
          <h6>
            <Link href={`/course-details/${courseDetails.id}`}>{courseDetails.title}</Link>
          </h6>
